        ...
        <header className="sticky top-0 z-50 flex h-16 shrink-0 items-center justify-between border-b border-border/40 bg-background/80 backdrop-blur-md px-6">
            <div className="flex items-center gap-4">
                <div className="flex items-center gap-2">
                    ...
                    <span className="rounded-full bg-primary/10 px-2.5 py-0.5 text-xs text-primary font-['Helvetica_Neue',_Helvetica,_sans-serif] font-light">0.31.6 Peregrine</span>
                </div >
            ...
            < div className="flex items-center gap-4" >
                <div className="flex items-center gap-2 text-sm">
                    <span className="text-xs text-muted-foreground">v0.31.6</span>
