...
import { X, ZoomIn, Play, Download, Save, Airplay } from "lucide-react"
...
interface MediaPreviewModalProps {
    ...
    onUseAsRef?: (url: string) => void // New Sideload Prop
}

import { useState, useEffect } from "react";
import { ChevronLeft, ChevronRight } from "lucide-react";

export function MediaPreviewModal({ isOpen, onClose, url, type, title, urls = [], onSave, onUseAsRef }: MediaPreviewModalProps) {
